//! Stats and display command handlers.
//!
//! Handles /stats, /cost, /context, and /usage slash commands that display
//! session statistics, token costs, context window usage, and rate limit data.
