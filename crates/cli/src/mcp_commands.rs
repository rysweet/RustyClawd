...
//! - `mcp_serve`: JSON-RPC 2.0 stdio server mode
//! - `mcp_dispatch`: CLI and TUI entry-point routing

use crate::plugins::mcp_proxy::McpProxy;
use std::sync::Arc;
use tokio::sync::Mutex;

// Re-export dispatch functions so existing call sites keep working
pub use crate::mcp_dispatch::{handle_cli_command, handle_tui_command, parse_slash_command};
