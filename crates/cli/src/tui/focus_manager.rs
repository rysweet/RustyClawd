//! Focus management, layout cache, and pane wrapper types for App.
//!
//! Handles rat-focus integration: focus flags, focus caching/rebuild,
//! HasFocus wrapper structs, and LayoutCache for hit testing.
