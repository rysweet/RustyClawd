...
Production Rust implementation of Claude Code with complete SDK and CLI spec compliance. ✅ **100% CLI Spec Compliant** - Matches [official Claude Code CLI](https://code.claude.com/docs/en/cli-reference) exactly
